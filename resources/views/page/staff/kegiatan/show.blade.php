    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="mb-6 flex justify-between items-start">
            ...
            <div class="flex space-x-3">
                ...
                <a href="{{ route('admin.kegiatan.index') }}" class="btn bg-gray-100 text-gray-700 hover:bg-gray-200">
                ...
                <div class="bg-white rounded-xl shadow-card p-6">
                    ...
                    <div class="space-y-3">
                        <a href="{{ route('admin.laporan.create', ['kegiatan_id' => $kegiatan->id]) }}"
                            class="flex items-center p-3 bg-green-50 hover:bg-green-100 rounded-lg text-green-700">
                            <i class="fas fa-file-signature text-lg mr-3"></i>
                            <div>
                                <p class="font-medium">Buat Laporan</p>
                                <p class="text-sm">Laporan kegiatan ini</p>
                            </div>
                        </a>
                        ...
                        <button
                            class="w-full flex items-center p-3 bg-red-50 hover:bg-red-100 rounded-lg text-red-700 confirm-delete"
                            onclick="document.getElementById('delete-form').submit()">
                            <i class="fas fa-trash-alt text-lg mr-3"></i>
                            <div>
                                <p class="font-medium">Hapus Kegiatan</p>
                                <p class="text-sm">Hapus permanen</p>
                            </div>
                        </button>

                        <form id="delete-form" action="{{ route('admin.kegiatan.destroy', $kegiatan->id) }}" method="POST"
                            class="hidden">
                            @csrf
                            @method('DELETE')
                        </form>
