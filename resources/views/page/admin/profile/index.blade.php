    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                ...
                <p class="text-slate-500 text-sm font-medium">Manage your personal information and account details</p>
            </div>
        </div>
                        ...
                        @if (auth()->user()->phone)
                            <div class="flex items-center gap-3 p-3 bg-slate-50 rounded-xl">
                                ...
                                <div class="min-w-0 flex-1">
                                    ...
                                    <p class="text-xs font-bold text-slate-700">{{ auth()->user()->phone }}</p>
                                </div>
                            </div>
                        @endif
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="flex items-center gap-4">
                                        ...
                                        <label for="photo-upload"
                                            ...
                                            <span class="font-semibold">Choose new photo</span>
                                        </label>
                                    </div>
                                    <p class="text-[10px] text-slate-400 italic">Recommended: Square image, max 2MB</p>
                                    @error('photo')
                                        <p class="mt-1 text-xs text-red-500 font-medium">{{ $message }}</p>
                                    @enderror
                                </div>
