...
@section('content')
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            ...
            <p class="text-slate-500 dark:text-slate-400 text-sm font-medium">Monitoring activity with a
        ...
        <div class="xl:col-span-3 space-y-4 sm:space-y-6">
            ...
            <div
                ...
                <div class="p-4 sm:p-5 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between">
                    ...
                    <a href="{{ route('pimpinan.kegiatan.index') }}"
                        ...
                        <tbody class="divide-y divide-slate-50 dark:divide-slate-800">
                            @forelse($recentActivities as $activity)
                                <tr class="hover:bg-beige-bg/30 dark:hover:bg-slate-800/50 transition-colors">
                                    ...
                                    <td class="px-4 sm:px-6 py-4">
                                        <span
                                            class="flex items-center gap-1.5 text-xs font-medium {{ $activity->status == 'completed' || $activity->status == 'disetujui' ? 'text-green-600' : 'text-amber-600' }}">
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="px-4 sm:px-6 py-4 text-center text-sm text-slate-500">No
                                        recent
                                        activities found.</td>
                                </tr>
                            @endforelse
